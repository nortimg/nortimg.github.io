...
function tazeros_stats_set_cookie(t, e, s) {
    var n = (s = s || {}).expires;
    if ("number" == typeof n && n) {
        var a = new Date;
        a.setTime(a.getTime() + 1e3 * n), n = s.expires = a
    }
    n && n.toUTCString && (s.expires = n.toUTCString());
...
function tazeros_get_dom_path(el) {
    var stack = [];
...
function tazeros_stats_remove_cookie(t) {
    tazeros_stats_set_cookie(t, "", {
        expires: -1
    })
}

function tazeros_stats_get_random(t, e) {
    return Math.round(Math.random() * (e - t) + t)
}

function tazeros_stats_distance(t, e, s, n) {
    var a = t - s, o = e - n;
